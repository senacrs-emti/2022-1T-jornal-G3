...
<main class="col-lg-9 col-12">
    ...
    <hr>
    <p class="p-noticia">Confira como ficou o grupo E após o fim da fase de grupos:</p>
    <img class="col-12 mb-3" style="border-radius: 2%;" src="./contents/grupo-e-noticia.png" alt="">
