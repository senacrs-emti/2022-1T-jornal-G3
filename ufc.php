...
<main class="col-lg-9 col-12">
    <img class="imagemeditoria mt-3" src="http://cdn.onlinewebfonts.com/svg/img_531807.png" alt="">
...
<div class="card bg-dark mt-5 mb-5 text-white card-noticia col-12">
  ...
  <div class="card-body">
    ...
    <a href="./entrevista-karate-machado.php" class="btn btn-light btn-block">Leia mais</a>
  </div>
</div>
